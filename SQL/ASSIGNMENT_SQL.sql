...
ALTER TABLE USERS 
 ADD profile_image NVARCHAR(255) NULL;
 ALTER TABLE USERS 
...
CREATE TABLE SHOES_IMAGE (
    ...
    FOREIGN KEY (SHOES_ID) REFERENCES SHOES_PRODUCT(SHOES_ID) ON DELETE CASCADE
);
...
CREATE TABLE OTP_CODES (
    ...
    CONSTRAINT FK_OTP_USER FOREIGN KEY (USER_NAME) REFERENCES USERS(USER_NAME) ON DELETE CASCADE
);