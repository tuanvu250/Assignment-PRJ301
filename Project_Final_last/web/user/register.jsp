    ...
    <body>
        ...
        <div class="signup">
            ...
            <%
                ...
                String errorUsername = request.getAttribute("errorMessUsername") != null ? (String) request.getAttribute("errorMessUsername") : "";
                String errorPassword = request.getAttribute("errorMessPassword") != null ? (String) request.getAttribute("errorMessPassword") : "";
                String errorCfPassword = request.getAttribute("errorMessCfPassword") != null ? (String) request.getAttribute("errorMessCfPassword") : "";
                String errorFullname = request.getAttribute("errorMessFullname") != null ? (String) request.getAttribute("errorMessFullname") : "";
                String errorEmail = request.getAttribute("errorMessEmail") != null ? (String) request.getAttribute("errorMessEmail") : "";
                String errorPhone = request.getAttribute("errorMessPhone") != null ? (String) request.getAttribute("errorMessPhone") : "";
