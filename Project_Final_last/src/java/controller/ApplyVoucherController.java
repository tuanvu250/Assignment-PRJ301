...
public class ApplyVoucherController extends HttpServlet {
    protected static final VoucherDAO dao = new VoucherDAO();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(code == null || code.trim().isEmpty()) {
                session.setAttribute("errorVoucherNull", "Please input discount code");
            } else {
                if(dao.checkVoucher(code)) {
                    session.setAttribute("successVoucher", "This code apply successful");
                    session.setAttribute("discountCode", code);
                } else {
                    session.setAttribute("errorVoucher", "This code cannot apply");
                }
            }
